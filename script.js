...
var botaoDescriptografar = document.querySelector(".btn-desencriptografar");
var menino = document.querySelector(".img-menino");
var contenedor = document.querySelector(".msg-texto");
...
function criptografar(){
    ocultarImagem();
    var textodigitado = recuperarTexto()
    resultado.textContent = criptografarTexto(textodigitado);
}

function descriptografar(){
    ocultarImagem();
    var textodigitado = recuperarTexto()
    resultado.textContent = descriptografarTexto(textodigitado);
}
